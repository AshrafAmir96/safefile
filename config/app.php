...
return [
    ...
    | and it will se application name defined from settings page.
    |
    */
    ...
    */
    ...
    'url' => env('APP_URL', 'http://boilerplate.valet'),
    ...
    |--------------------------------------------------------------------------
    |
    | This URL is used by asset for your application such as image, css or
    | video to reduce request from application url.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This API domain is used by routing provider to allow api access from
    | sub domain instead of prefix path. Default is empty (using prefix).
    |
    */
