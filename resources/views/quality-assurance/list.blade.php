...
@section('page-title', trans('app.quality-assurance'))
@section('page-heading', trans('app.quality-assurance'))
...
<div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item">@lang('app.quality-assurance')</div>
</div>
@stop
            ...
            <div class="row my-3 flex-md-row flex-column-reverse">
                <div class="col-md-4 mt-md-0 mt-2">
                    <div class="input-group custom-search-form">
                        <input type="text" class="form-control input-solid" name="search" value="" placeholder="Search for quality control document..">
