...
@section('page-title', trans('app.specification'))
@section('page-heading', trans('app.specification'))
...
@section('breadcrumbs')
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">@lang('app.specification')</div>
    </div>
@stop
        ...
        <div class="table-responsive" id="users-table-wrapper">
            <table class="table table-borderless table-striped">
                ...
                <tr>
                    ...
                    <th class="min-width-100">Price (RM)</th>
