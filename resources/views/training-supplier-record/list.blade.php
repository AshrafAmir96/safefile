...
@section('page-title', trans('app.training_supplier_record'))
@section('page-heading', trans('app.training_supplier_record'))
...
<div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item">@lang('app.training_supplier_record')</div>
</div>
@stop
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-primary">View all training conducted</button>
                        </td>
                    </tr>
                    <tr>
                        <td>2</td>
