...
@section('page-title', trans('app.certicate_tracking'))
@section('page-heading', trans('app.certicate_tracking'))
...
@section('breadcrumbs')
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">@lang('app.certicate_tracking')</div>
    </div>
@stop
                ...
                <div class="col-md-4 mt-md-0 mt-2">
                    <div class="input-group custom-search-form">
                        <input type="text"
                               ...
                               placeholder="Search Certificate Reference Number ...">
        ...
        <div class="table-responsive" id="users-table-wrapper">
            <table class="table table-borderless table-striped">
                ...
                <tr>
                    ...
                    <th class="min-width-100">Company</th>
                    <th class="min-width-80">POC</th>
                    <th class="min-width-80">Attachment</th>
                    <th class="min-width-80">Date</th>
                ...
                <tbody>
                    @if (count($users))
                         <tr>
                            <td> <a href="#">CER-2021-0001992381</a></td>
                            <td> <a href="#">Company 1</a></td>
                            <td> <a href="#">Company 1 Staff 1 </a></td>
