...
@section('page-title', trans('app.laboratory_instru'))
@section('page-heading', trans('app.laboratory_instru'))
...
@section('breadcrumbs')
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">@lang('app.laboratory_instru')</div>
    </div>
@stop
                ...
                <div class="col-md-3 mt-md-0 mt-2">
                    <div class="input-group custom-search-form">
                        <input type="text"
                               ...
                               placeholder="Search Lab Instrument ...">
        ...
        <div class="table-responsive" id="users-table-wrapper">
            <table class="table table-borderless table-striped">
                ...
                <tr>
                    ...
                    <th class="min-width-150">Equipment Name</th>
