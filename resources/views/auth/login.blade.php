        ...
        <div class="card-body">
            ...
            <form method="POST" action="<?= url('login') ?>" id="login-form" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input aria-describedby="emailHelpBlock" id="username" type="text" class="form-control"
                        name="username" placeholder="@lang('app.email_or_username')" tabindex="1" autofocus>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input aria-describedby="passwordHelpBlock" id="password" type="password"
                        placeholder="@lang('app.password')" class="form-control" name="password" tabindex="2">
                </div>
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-danger btn-lg btn-block" href="#" onclick="loginAdmin()">Log Masuk Sebagai
                        Admin</a>
                </div>
            </form>
