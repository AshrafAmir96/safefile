...
@section('page-title', trans('app.outside_services_filtration'))
@section('page-heading', trans('app.outside_services_filtration'))
...
<div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item">@lang('app.outside_services_filtration')</div>
</div>
@stop
...
<div class="card">
    <div class="card-body">
            ...
            <div class="row my-3 flex-md-row flex-column-reverse">
                <div class="col-md-4 mt-md-0 mt-2">
                    <div class="input-group custom-search-form">
                        <input type="text" class="form-control input-solid" name="search" value="" placeholder="Search for filtration...">
        ...
        <div class="table-responsive" id="users-table-wrapper">
            <p>Assign technician to the filtration job by clicking the pencil icon and reschedule scheduled date by clicking the calendar icon. View the technician profile by clicking the technician name.</p>
