...
@section('page-title', trans('app.waste'))
@section('page-heading', trans('app.waste'))
...
<div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item">@lang('app.waste')</div>
</div>
@stop
...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive" id="users-table-wrapper">
            <p>Assign technician to job by clicking the pencil icon and reschedule scheduled date by clicking the calendar icon. View the technician and supplier profile by clicking the technician name.</p>
