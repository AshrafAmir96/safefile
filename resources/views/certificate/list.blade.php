...
@section('page-title', trans('app.certificate'))
@section('page-heading', trans('app.certificate'))
...
<div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item">@lang('app.certificate')</div>
</div>
@stop
            ...
            <div class="row my-3 flex-md-row flex-column-reverse">
                <div class="col-md-4 mt-md-0 mt-2">
                    <div class="input-group custom-search-form">
                        <input type="text" class="form-control input-solid" name="search" value="" placeholder="Search for certificate ..">
