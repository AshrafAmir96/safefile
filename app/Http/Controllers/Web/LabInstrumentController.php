...
class LabInstrumentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $validation_statuses = array(""=>"All Status","1"=>"Available", "2"=>"Unvailable");
        ...
        return view('lab_instrument.list', compact('users', 'test_types','approval_statuses','validation_statuses'));
    }
