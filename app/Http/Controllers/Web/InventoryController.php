...
class InventoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $validation_statuses = array(""=>"All Stock Type","1"=>"Chemical", "2"=>"Consumable", "3"=>"PPE");
        $approval_statuses = array(""=>"All Status","1"=>"Pending", "2"=>"Confirmed","3"=>"Rejected");
        $test_types = array(""=>"All Test Type","1"=>"High Power", "2"=>"High Voltage", "3"=>"High Voltage & Medium Power" ,"4"=>"High Power & High Voltage");

        return view('inventory.list', compact('users', 'test_types','approval_statuses','validation_statuses'));
    }
