...
class ProductEtodsKitController extends Controller
{
    /**
     * @var UserRepository
     */
    ...
    public function index(Request $request)
    {
        ...
        return view('product-etods-kit.list', compact('users', 'statuses', 'usersPerMonth'));
    }
    ...
    public function create(CountryRepository $countryRepository, RoleRepository $roleRepository)
    {
        ...
        return view('product-etods-kit.add', compact('countries', 'roles', 'statuses'));
    }
