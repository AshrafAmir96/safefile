...
class LaboratoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $regions = array(""=>"All Region","1"=>"Region 1", "2"=>"Region 2", "3"=>"Region 3");
        $statuses = array(""=>"All Status","1"=>"Active", "2"=>" Not Active");
        $lab_types = array(""=>"All Laboratory Type","1"=>"High Power", "2"=>"High Voltage", "3"=>"High Voltage & Medium Power" ,"4"=>"High Power & High Voltage");

        return view('laboratory.list', compact('users', 'statuses','regions','lab_types'));
    }
