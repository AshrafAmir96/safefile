...
class CSIRecordController extends Controller
{
    /**
     * @var UserRepository
     */
    ...
    public function index(Request $request)
    {
        ...
        return view('csi-record.list', compact('users', 'statuses'));
    }
    ...
    public function create(CountryRepository $countryRepository, RoleRepository $roleRepository)
    {
        ...
        return view('csi-record.add', compact('countries', 'roles', 'statuses'));
    }
