...
class TrainingSupplierRecordController extends Controller
{
    /**
     * @var UserRepository
     */
    ...
    public function index(Request $request)
    {
        ...
        return view('training-supplier-record.list', compact('users', 'statuses'));
    }
    ...
    public function create(CountryRepository $countryRepository, RoleRepository $roleRepository)
    {
        ...
        return view('training-supplier-record.add', compact('countries', 'roles', 'statuses'));
    }
