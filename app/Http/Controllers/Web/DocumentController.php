...
class DocumentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $validation_statuses = array(""=>"All Status","1"=>"New", "2"=>"Approved", "3"=>"Rejected");
        ...
        return view('document.list', compact('users', 'test_types','approval_statuses','validation_statuses'));
    }
