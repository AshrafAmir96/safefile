...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $validation_statuses = array(""=>"All Validation Status","1"=>"Pending", "2"=>"Approved", "3"=>"Rejected");
        $approval_statuses = array(""=>"All Approval Status","1"=>"Pending", "2"=>"Approved","3"=>"Rejected");
        $test_types = array(""=>"All Satisfaction Type","1"=>"Positive", "2"=>"Negative", "3"=>"Neutral");
        $allocation_types  = array(""=>"All Test Type","1"=>"High Power", "2"=>"High Voltage", "3"=>"High Voltage & Medium Power" ,"4"=>"High Power & High Voltage");

        return view('customer-satisfaction.list', compact('users','allocation_types','test_types','approval_statuses','validation_statuses'));
    }
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function customer_invoice_list(Request $request)
    {
        $users = $this->users->paginate(
            $perPage = 20,
            $request->get('search'),
        ...
        $validation_statuses = array(""=>"All Status","1"=>"Pending", "2"=>"Approved", "3"=>"Rejected");
        $approval_statuses = array(""=>"All Invoice Type","1"=>"Performa", "2"=>"Commercial");
        $test_types = array(""=>"All Test Type","1"=>"High Power", "2"=>"High Voltage", "3"=>"High Voltage & Medium Power" ,"4"=>"High Power & High Voltage");

        return view('customer-invoice.list', compact('users', 'test_types','approval_statuses','validation_statuses'));
    }
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function customer_spec_list(Request $request)
    {
        $users = $this->users->paginate(
            $perPage = 20,
            $request->get('search'),
        ...
        $validation_statuses = array(""=>"All Validation Status","1"=>"Pending", "2"=>"Approved", "3"=>"Rejected");
        $approval_statuses = array(""=>"All Status","1"=>"Pending", "2"=>"Approved","3"=>"Rejected");
        $allocation_types = array(""=>"All Allocation Type","1"=>"Normal", "2"=>"Urgent");
        $test_types = array(""=>"All Test Type","1"=>"High Power", "2"=>"High Voltage", "3"=>"High Voltage & Medium Power" ,"4"=>"High Power & High Voltage");

        return view('customer-specification.list', compact('users', 'test_types','approval_statuses','validation_statuses','allocation_types'));
    }
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function customer_cer_list(Request $request)
    {
        $users = $this->users->paginate(
            $perPage = 20,
            $request->get('search'),
        ...
        $validation_statuses = array(""=>"All Validation Status","1"=>"Pending", "2"=>"Approved", "3"=>"Rejected");
        $approval_statuses = array(""=>"All Status","1"=>"Active", "2"=>"Inactive");
        $allocation_types = array(""=>"All Allocation Type","1"=>"Normal", "2"=>"Urgent");
        $test_types = array(""=>"All Test Type","1"=>"High Power", "2"=>"High Voltage", "3"=>"High Voltage & Medium Power" ,"4"=>"High Power & High Voltage");

        return view('customer-certificate.list', compact('users', 'test_types','approval_statuses','validation_statuses','allocation_types'));
    }
    ...
    public function create(CountryRepository $countryRepository, RoleRepository $roleRepository)
    {
        ...
        return view('content.add', compact('countries', 'roles', 'statuses'));
    }
