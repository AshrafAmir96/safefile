...
class TenderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $validation_statuses = array(""=>"All Tender Status","1"=>"Open", "2"=>"Closed", "3"=>"Pending");
        $approval_statuses = array(""=>"All Approval Status","1"=>"Pending", "2"=>"Approved","3"=>"Rejected");
        $test_types = array(""=>"All Company","1"=>"Company 1", "2"=>"Company 2");

        return view('tender.list', compact('users', 'test_types','approval_statuses','validation_statuses'));
    }
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function customer_status_list(Request $request)
    {
        $users = $this->users->paginate(
            $perPage = 20,
            $request->get('search'),
        ...
        $approval_statuses = array(""=>"All Allocation Type","1"=>"Normal", "2"=>"Urgent");
        $test_types = array(""=>"All Test Type","1"=>"High Power", "2"=>"High Voltage", "3"=>"High Voltage & Medium Power" ,"4"=>"High Power & High Voltage");

        return view('inhouse-validation.list', compact('users', 'test_types','approval_statuses','validation_statuses'));
    }
    ...
    public function customer_spec_list(Request $request)
    {
        ...
        $validation_statuses = array(""=>"All Validation Status","1"=>"Pending", "2"=>"Approved", "3"=>"Rejected");
        $approval_statuses = array(""=>"All Approval Status","1"=>"Pending", "2"=>"Approved","3"=>"");
        $allocation_types = array(""=>"All Allocation Type","1"=>"Normal", "2"=>"Urgent");
        $test_types = array(""=>"All Test Type","1"=>"High Power", "2"=>"High Voltage", "3"=>"High Voltage & Medium Power" ,"4"=>"High Power & High Voltage");

        return view('inhouse-approval.list', compact('users', 'test_types','approval_statuses','validation_statuses','allocation_types'));
    }
    ...
    public function customer_cer_list(Request $request)
    {
        ...
        return view('inhouse-reporting.list', compact('users', 'test_types','approval_statuses','validation_statuses','allocation_types'));
    }
