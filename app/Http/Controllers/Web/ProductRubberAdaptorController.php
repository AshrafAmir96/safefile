...
class ProductRubberAdaptorController extends Controller
{
    /**
     * @var UserRepository
     */
    ...
    public function index(Request $request)
    {
        ...
        return view('product-rubber-adaptor.list', compact('users', 'statuses', 'usersPerMonth'));
    }
    ...
    public function create(CountryRepository $countryRepository, RoleRepository $roleRepository)
    {
        ...
        return view('product-rubber-adaptor.add', compact('countries', 'roles', 'statuses'));
    }
