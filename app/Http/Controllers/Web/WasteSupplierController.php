...
class WasteSupplierController extends Controller
{
    /**
     * @var UserRepository
     */
    ...
    public function index(Request $request)
    {
        ...
        return view('waste-supplier.list', compact('users', 'statuses', 'usersPerMonth'));
    }
    ...
    public function create(CountryRepository $countryRepository, RoleRepository $roleRepository)
    {
        ...
        return view('waste-supplier.add', compact('countries', 'roles', 'statuses'));
    }
